...
import { GlobalHeaderCentered } from '@/components/global-header/GlobalHeaderCentered.dev';
...
describe('GlobalHeaderCentered Component', () => {
  it('renders without crashing with centered layout', () => {
    const { container } = render(<GlobalHeaderCentered {...mockGlobalHeaderProps} />);
    expect(container.querySelector('header')).toBeInTheDocument();
  });

  it('displays logo, navigation menu, and contact button', () => {
